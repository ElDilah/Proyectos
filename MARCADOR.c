       ...
       switch (tecla_pulsada)
        {
            case '0':   // BOTÓN START/STOP //
                ...
                else if (Estado[0] ==PARADO)  {// SI ESTA PARADO Y SE PULSA MARCHA
                     Estado[0] = Estado[1];
                     Estado[1] = PARADO;
                     enable_interrupts(INT_TIMER1);
                     set_timer1(63036);
...
//
//
//int Estado[2]={0,0};   //Variable que almacena el estado activo actual y anterior//
//
//int Puntos_local = 0;  //Variable que contabiliza los puntos del equipo local//
//int Puntos_visitante = 0;  //Variable que contabiliza los puntos del equipo visitante//
//
...
//char texto[10]; //Variable auxiliar para mostrar texto en el LCD en función de la situación//
//
//char tecla_pulsada='\0';  //Variable auxiliar para localizar la tecla pulsada//
//
////////////////////////////////
////ESTADOS MÁQUINA DE ESTADOS//
////////////////////////////////
...
//{
//    
//    delay_ms(500);  // DELAY PARA MINIMIZAR EFECTO DE REBOTES //
//    
//       salida1 = 0;
//       salida2 = 1;
//       salida3 = 1;
...
//                    Estado[0] = PRIMER_CUARTO;
//                }
//                else if(Estado[0] == PARADO)  //Si el estado activo es PARADO establece el estado activo al anterior en el que estaba antes de estar en PARADO//
//                {
//                    Estado[0] = Estado[1];
//                    Estado[1]=PARADO;    //Establece estado anterior a PARADO//
//                }
//                else
//                {
//                    Estado[1]=Estado[0];   //Si el estado activo no es ni INICIO ni PARADO desplaza tabla y pone como estado activo el estado PARADO//
//                    Estado[0]=PARADO;
//                }
//                
//                tecla_pulsada = '\0';  //Reinicio la variable tecla_pulsada al valor conjunto vacío//
//                
//                break;
//            
//            case '1':  // BOTÓN CAMBIO DE POSESIÓN //
...
//            case '5': // BOTÓN FALTAS LOCAL //
//                
//                Faltas_local = Faltas_local + 1;
//                
//                if (Faltas_local == 5)  //Si el número de faltas del equipo local llega a 5 poner el símbolo de bonus en el marcador//
//                {
//                    lcd_gotoxy(2,1);
//                    printf(lcd_putc,"*");
//                }
...
//            case '6': // BOTÓN FALTAS VISITANTE //
//                
//                 Faltas_visitante = Faltas_visitante + 1;
//                
//                if (Faltas_visitante == 5)  //Si el número de faltas del equipo visitante llega a 5 poner el símbolo de bonus en el marcador//
//                {
//                    lcd_gotoxy(16,1);    
//                    printf(lcd_putc,"*");
//                }
...
//                else
//                {
//                    Puntos_visitante = Puntos_visitante + 1;
//                    
//                    //Actualizo LCD//
//                
//                    lcd_gotoxy(13,2);
//                    printf(lcd_putc,"%3d",Puntos_visitante);
//                }
//                               
//                tecla_pulsada = '\0';   //Reinicio la variable tecla_pulsada al valor conjunto vacío//
//                
...
//                   lcd_clr_line(2);
//                   
//                   Estado[1]=Estado[0];   //Desplazo tabla y indico que el estado activo es INICIO//
//                   Estado[0]=INICIO;
//               }
//          
//          
...
//               
//               
//               TEMPORIZACION_TIEMPO_MARCADOR();   //INICIALIZO LA TEMPORIZACIÓN//
//               
//               if((Estado[0] == PARADO)||(Estado[0] == TIEMPO_MUERTO))  //Si el estado activo es PARADO o TIEMPO MUERTO salimos del estado PRIMER CUARTO//
//               {
//                   break;
//               }
//               else  //Si el estado activo no es PARADO ni TIEMPO MUERTO significa que la temporización acabó y debe haber un descanso//
//               {
//                   Estado[1]=Estado[0];  //Desplazo tabla y establezco como estado activo el estado DESCANSO//
//                   Estado[0] = DESCANSO;
//               }
...
//              printf(lcd_putc,"%d",Cuarto_de_juego);
//               
//               TEMPORIZACION_TIEMPO_MARCADOR();   //INICIO TEMPORIZACIÓN SEGUNDO CUARTO//
//               
//               if((Estado[0] == PARADO)||(Estado[0] == TIEMPO_MUERTO))  //Si el estado activo es PARADO o TIEMPO MUERTO salimos del estado SEGUNDO CUARTO//
//               {
//                   break;
